let github_canlendar = (git_user, git_color) => {
    let git_githubapiurl = "https://github-calendar-api.vercel.app/api?" + git_user;
    let git_fixed = 'fixed';
    let git_px = 'px';
    ...
    let tooltip_html = (x, y, span1, span2) => {
        let html = '';
        html += '<div class="gitmessage" style="top:' + 20 + 'px;left:' + 20 + 'px;position: fixed;z-index:9999;"><div class="angle-wrapper" style="display:block; opacity:0.5;"><span>' + span1 + '&nbsp;</span><span>' + span2 + ' 次上传</span></div></div>';
        return html
    };
...
(function(){let git_user = 'LuSuZi';
    ...
    let git_gray = ['#fafbfc', '#ebedf0', '#e1e4e8', '#d1d5da', '#959da5', '#6a737d', '#586069', '#444d56', '#2f363d', '#24292e'];
    let git_color = git_gray;
